...
import net.sf.l2j.gameserver.util.RewardHolder;
...
public final class Config
{
	...
	public static final String Special_FILE = "./config/CustomMods/SpecialMods.ini";
	public static final String TOURNAMENT = "./config/CustomMods/Tournament.ini";
	...
	/**
	 * Loads settings from all configuration files Tournament.
	 */
	...
	private static final void loadSpecialMod()
	{
	 	final ExProperties Special = initProperties(Special_FILE);
		ALT_GAME_VIEWNPC = Boolean.parseBoolean(Special.getProperty("AltGameViewNpc", "True"));
	}
