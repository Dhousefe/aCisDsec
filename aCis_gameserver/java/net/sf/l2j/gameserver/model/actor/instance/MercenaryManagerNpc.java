...
public final class MercenaryManagerNpc extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("how_to"))
		{
			...
			html.setFile("data/html/mercmanager/mseller005.htm", player);
		...
		else if (command.startsWith("hire"))
		{
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile("data/html/mercmanager/msellerdenial.htm", player);
				html.replace("%objectId%", getObjectId());
				player.sendPacket(html);
				return;
			}
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/mercmanager/mseller004.htm", player);
			player.sendPacket(html);
		}
		else if (command.startsWith("merc_limit"))
		{
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/mercmanager/" + ((getCastle().getId() == 5) ? "aden_msellerLimit.htm" : "msellerLimit.htm"), player);
	...
	public void showChatWindow(Player player)
	{
		...
		{
			case NONE:
				html.setFile("data/html/mercmanager/mseller002.htm", player);
				break;
			
			case UNDER_SIEGE:
				html.setFile("data/html/mercmanager/mseller003.htm", player);
				break;
			...
			default:
				...
				{
					case DAWN:
						html.setFile("data/html/mercmanager/mseller001_dawn.htm", player);
						break;
					
					case DUSK:
						html.setFile("data/html/mercmanager/mseller001_dusk.htm", player);
						break;
					
					default:
						html.setFile("data/html/mercmanager/mseller001.htm", player);
						break;
				}
				break;
		}
