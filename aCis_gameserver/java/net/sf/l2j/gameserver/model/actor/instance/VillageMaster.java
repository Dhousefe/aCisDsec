...
public class VillageMaster extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (actualCommand.equalsIgnoreCase("change_clan_leader"))
		{
			...
			if (clan.getNewLeaderId() == 0)
			{
				...
				html.setFile("data/html/script/feature/Clan/9000-07-success.htm", player);
			}
			else
				html.setFile("data/html/script/feature/Clan/9000-07-in-progress.htm", player);
		...
		else if (actualCommand.equalsIgnoreCase("cancel_clan_leader_change"))
		{
			...
			if (clan.getNewLeaderId() != 0)
			{
				...
				html.setFile("data/html/script/feature/Clan/9000-08-success.htm", player);
			}
			else
				html.setFile("data/html/script/feature/Clan/9000-08-no.htm", player);
		...
		else if (command.startsWith("Subclass"))
		{
			...
			switch (cmdChoice)
			{
				case 0: // Subclass change menu
					html.setFile("data/html/villagemaster/SubClass.htm", player);
					break;
				...
				case 1: // Add Subclass - Initial
					...
					{
						html.setFile("data/html/villagemaster/SubClass_Fail.htm", player);
						break;
					}
					...
					html.setFile("data/html/villagemaster/SubClass_Add.htm", player);
				...
				case 2: // Change Class - Initial
					...
					if (player.getSubClasses().isEmpty())
						html.setFile("data/html/villagemaster/SubClass_ChangeNo.htm", player);
					else
					{
						sb = new StringBuilder(300);
						...
						if (sb.length() > 0)
						{
							html.setFile("data/html/villagemaster/SubClass_Change.htm", player);
							html.replace("%list%", sb.toString());
						}
						else
							html.setFile("data/html/villagemaster/SubClass_ChangeNotFound.htm", player);
					}
					break;
				...
				case 3: // Change/Cancel Subclass - Initial
					if (player.getSubClasses().isEmpty())
					{
						html.setFile("data/html/villagemaster/SubClass_ModifyEmpty.htm", player);
						break;
					}
					
					html.setFile("data/html/villagemaster/SubClass_Modify.htm", player);
				...
				case 4: // Add Subclass - Action (Subclass 4 x[x])
					...
					if (allowAddition && isValidNewSubClass(player, paramOne))
					{
						...
						html.setFile("data/html/villagemaster/SubClass_AddOk.htm", player);
				...
				case 5: // Change Class - Action
					...
					{
						html.setFile("data/html/villagemaster/SubClass_Current.htm", player);
						break;
					}
				...
				case 6: // Change/Cancel Subclass - Choice
					...
					{
						case 1:
							html.setFile("data/html/villagemaster/SubClass_ModifyChoice1.htm", player);
							break;
						
						case 2:
							html.setFile("data/html/villagemaster/SubClass_ModifyChoice2.htm", player);
							break;
						
						case 3:
							html.setFile("data/html/villagemaster/SubClass_ModifyChoice3.htm", player);
							break;
						
						default:
							html.setFile("data/html/villagemaster/SubClass_ModifyChoice.htm", player);
					}
					html.replace("%list%", sb.toString());
					break;
				...
				case 7: // Change Subclass - Action
					...
					if (player.modifySubClass(paramOne, paramTwo))
					{
						...
						html.setFile("data/html/villagemaster/SubClass_ModifyOk.htm", player);
	...
	public static final void showPledgeSkillList(Player player)
	{
		if (!player.isClanLeader())
		{
			...
			html.setFile("data/html/script/feature/Clan/9000-09-no.htm", player);
			player.sendPacket(html);
