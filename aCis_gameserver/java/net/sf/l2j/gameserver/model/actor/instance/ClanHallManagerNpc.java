...
public class ClanHallManagerNpc extends Merchant
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		if (actualCommand.equalsIgnoreCase("banish_foreigner"))
		{
			...
			if (val.equalsIgnoreCase("list"))
				html.setFile("data/html/clanHallManager/banish-list.htm", player);
			else if (val.equalsIgnoreCase("banish"))
			{
				getClanHall().banishForeigners();
				html.setFile("data/html/clanHallManager/banish.htm", player);
			}
		...
		else if (actualCommand.equalsIgnoreCase("manage_vault"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/clanHallManager/vault" + (isSCH ? "-sch" : "") + ".htm", player);
		...
		else if (actualCommand.equalsIgnoreCase("door"))
		{
			...
			if (val.equalsIgnoreCase("open"))
			{
				...
				html.setFile("data/html/clanHallManager/door-open.htm", player);
			}
			else if (val.equalsIgnoreCase("close"))
			{
				getClanHall().closeDoors();
				html.setFile("data/html/clanHallManager/door-close.htm", player);
			}
			else
				html.setFile("data/html/clanHallManager/door.htm", player);
		...
		else if (actualCommand.equalsIgnoreCase("functions"))
		{
			...
			if (val.equalsIgnoreCase("tele"))
			{
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile("data/html/clanHallManager/functions-disabled.htm", player);
					html.replace("%objectId%", getObjectId());
					player.sendPacket(html);
					return;
				}
			...
			else if (val.equalsIgnoreCase("support"))
			{
				...
				{
					html.setFile("data/html/clanHallManager/support" + chf.getLvl() + ".htm", player);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile("data/html/clanHallManager/functions.htm", player);
		...
		else if (actualCommand.equalsIgnoreCase("manage"))
		{
			...
			if (val.equalsIgnoreCase("recovery"))
			{
				if (st.hasMoreTokens())
				{
					...
					{
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile("data/html/clanHallManager/functions-cancel.htm", player);
					...
					{
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile("data/html/clanHallManager/functions-apply.htm", player);
					...
					else if (val.equalsIgnoreCase("hp"))
					{
						...
						{
							html.setFile("data/html/clanHallManager/functions-used.htm", player);
						...
						html.setFile("data/html/clanHallManager/functions-apply_confirmed.htm", player);
						
						int fee = cost;
						if (percent == 0)
						{
							fee = 0;
							html.setFile("data/html/clanHallManager/functions-cancel_confirmed.htm", player);
						}
						
						if (!getClanHall().updateFunction(player, ClanHall.FUNC_RESTORE_HP, percent, fee, TimeUnit.DAYS.toMillis(days)))
							html.setFile("data/html/clanHallManager/low_adena.htm", player);
						else
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile("data/html/clanHallManager/edit_recovery.htm", player);
			...
			else if (val.equalsIgnoreCase("other"))
			{
				...
				else
				{
					final boolean isSCH = (getClanHall() instanceof SiegableHall);
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile("data/html/clanHallManager/edit_other.htm", player);
			...
			else if (val.equalsIgnoreCase("deco"))
			{
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile("data/html/clanHallManager/deco.htm", player);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile((getClanHall() instanceof SiegableHall) ? "data/html/clanHallManager/manage_sch.htm" : "data/html/clanHallManager/manage.htm", player);
				html.replace("%objectId%", getObjectId());
				player.sendPacket(html);
			}
		}
		...
		{
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/clanHallManager/chamberlain.htm", player);
	...
	public void showChatWindow(Player player)
	{
		...
		final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
		html.setFile("data/html/clanHallManager/chamberlain" + ((getNpcTalkCond(player) == NpcTalkCond.OWNER) ? ".htm" : "-no.htm"), player);
		html.replace("%objectId%", getObjectId());
		player.sendPacket(html);
	}
	...
	private boolean validatePrivileges(Player player, PrivilegeType privilege)
	{
		...
		{
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/clanHallManager/not_authorized.htm", player);
			player.sendPacket(html);
			return false;
		}
		return true;
