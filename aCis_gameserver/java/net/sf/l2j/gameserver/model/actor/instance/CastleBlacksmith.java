...
public class CastleBlacksmith extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		if (!Config.ALLOW_MANOR)
		{
			...
			html.setFile("data/html/npcdefault.htm", player);
	...
	public void showChatWindow(Player player, int val)
	{
		...
		{
			case NONE:
				html.setFile("data/html/castleblacksmith/castleblacksmith-no.htm", player);
				break;
			
			case UNDER_SIEGE:
				html.setFile("data/html/castleblacksmith/castleblacksmith-busy.htm", player);
				break;
			
			default:
				if (val == 0)
					html.setFile("data/html/castleblacksmith/castleblacksmith.htm", player);
				else
					html.setFile("data/html/castleblacksmith/castleblacksmith-" + val + ".htm", player);
				break;
		}
		html.replace("%objectId%", getObjectId());
		html.replace("%npcname%", getName());
