...
public class CastleMagician extends Folk
{
	...
	public void showChatWindow(Player player, int val)
	{
		...
		{
			case NONE:
				html.setFile("data/html/castlemagician/magician-no.htm", player);
				break;
			
			case UNDER_SIEGE:
				html.setFile("data/html/castlemagician/magician-busy.htm", player);
				break;
			
			default:
				if (val == 0)
					html.setFile("data/html/castlemagician/magician.htm", player);
				else
					html.setFile("data/html/castlemagician/magician-" + val + ".htm", player);
				break;
		}
