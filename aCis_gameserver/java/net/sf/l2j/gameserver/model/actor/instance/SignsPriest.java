			...
			switch (value)
			{
				...
				case 6: // "Contribute Blue/Green/Red/all of my Seal Stones.", "Receive bonuses for gathering seal stones." [SevenSigns 6 stone]
					...
					else
					{
						...
						html.setFile(SevenSignsManager.SEVEN_SIGNS_HTML_PATH + ((this instanceof DawnPriest) ? "signs_6_dawn_contribute.htm" : "signs_6_dusk_contribute.htm"), player);
				...
				case 17: // "Exchange Blue/Green/Red/all Seal Stones.", [SevenSigns 17 stone]
					...
					html.setFile(SevenSignsManager.SEVEN_SIGNS_HTML_PATH + ((this instanceof DawnPriest) ? "signs_17_dawn.htm" : "signs_17_dusk.htm"), player);
					html.replace("%stoneColor%", stoneColor);
