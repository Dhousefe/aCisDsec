...
public class DerbyTrackManagerNpc extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.equals("ShowOdds"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(getHtmlPath(getTemplate().getNpcId(), 5), player);
			for (int i = 0; i < 8; i++)
			{
				final int n = i + 1;
		...
		{
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(getHtmlPath(getTemplate().getNpcId(), 6), player);
		...
		else if (command.equals("ShowTickets"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(getHtmlPath(getTemplate().getNpcId(), 7), player);
		...
		else if (command.startsWith("ShowTicket"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(getHtmlPath(getTemplate().getNpcId(), 8), player);
		...
		else if (command.equals("ViewHistory"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(getHtmlPath(getTemplate().getNpcId(), 9), player);
