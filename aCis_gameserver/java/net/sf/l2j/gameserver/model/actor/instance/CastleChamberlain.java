...
public class CastleChamberlain extends Merchant
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		if (condition == NpcTalkCond.NONE)
		{
			...
			html.setFile("data/html/chamberlain/noprivs.htm", player);
		...
		{
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/chamberlain/busy.htm", player);
			player.sendPacket(html);
			return;
		}
		...
		else if (actualCommand.equalsIgnoreCase("receive_report"))
		{
			...
			else
			{
				...
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile("data/html/chamberlain/report.htm", player);
		...
		else if (actualCommand.equalsIgnoreCase("operate_door")) // door control
		{
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile("data/html/chamberlain/" + getNpcId() + "-d.htm", player);
				html.replace("%objectId%", getObjectId());
				player.sendPacket(html);
				return;
			}
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile((open) ? "data/html/chamberlain/doors-open.htm" : "data/html/chamberlain/doors-close.htm", player);
			html.replace("%objectId%", getObjectId());
			player.sendPacket(html);
		...
		else if (actualCommand.equalsIgnoreCase("tax_set")) // tax rates control
		{
			...
			if (!validatePrivileges(player, PrivilegeType.CP_MANAGE_TAXES))
			{
				html.setFile("data/html/chamberlain/tax-member.htm", player);
			...
			html.setFile("data/html/chamberlain/tax-leader.htm", player);
			html.replace("%currentTaxRate%", getCastle().getCurrentTaxPercent());
			html.replace("%nextTaxRate%", getCastle().getNextTaxPercent());
			html.replace("%objectId%", getObjectId());
		...
		else if (actualCommand.equalsIgnoreCase("tax_adjust")) // tax rates control
		{
			...
			{
				html.setFile("data/html/chamberlain/tax-toohigh.htm", player);
				html.replace("%objectId%", getObjectId());
			...
			html.setFile("data/html/chamberlain/tax-after.htm", player);
			html.replace("%nextTaxRate%", getCastle().getNextTaxPercent());
			html.replace("%objectId%", getObjectId());
			player.sendPacket(html);
		}
		...
		else if (actualCommand.equals("give_crown"))
		{
			...
			if (condition == NpcTalkCond.OWNER)
			{
				if (player.getInventory().getItemByItemId(6841) == null)
				{
					...
					html.setFile("data/html/chamberlain/gavecrown.htm", player);
					html.replace("%CharName%", player.getName());
					html.replace("%FeudName%", getCastle().getName());
				}
				else
					html.setFile("data/html/chamberlain/hascrown.htm", player);
			}
			else
				html.setFile("data/html/chamberlain/noprivs.htm", player);
		...
		else if (actualCommand.equals("manor_certificate"))
		{
			...
			if (SevenSignsManager.getInstance().isSealValidationPeriod())
			{
				if (SevenSignsManager.getInstance().getPlayerCabal(player.getObjectId()) == CabalType.DUSK)
					html.setFile("data/html/chamberlain/not-dawn-or-event.htm", player);
				// We already reached the tickets limit.
				else if (getCastle().getLeftCertificates() == 0)
					html.setFile("data/html/chamberlain/not-enough-ticket.htm", player);
				else
				{
					html.setFile("data/html/chamberlain/sell-dawn-ticket.htm", player);
		...
		else if (actualCommand.equals("validate_certificate"))
		{
			...
			if (SevenSignsManager.getInstance().isSealValidationPeriod())
			{
				...
				else if (player.reduceAdena(CERTIFICATES_BUNDLE * CERTIFICATES_PRICE, true))
				{
					...
					html.setFile("data/html/chamberlain/not-enough-adena.htm", player);
			}
			else
				html.setFile("data/html/chamberlain/not-dawn-or-event.htm", player);
		...
		else if (actualCommand.equalsIgnoreCase("doors_update"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			if (val.isEmpty())
				html.setFile("data/html/chamberlain/" + getNpcId() + "-gu.htm", player);
			else
			{
				html.setFile("data/html/chamberlain/doors-update.htm", player);
				html.replace("%id%", val);
		...
		else if (actualCommand.equalsIgnoreCase("doors_choose_upgrade"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/chamberlain/doors-confirm.htm", player);
			html.replace("%objectId%", getObjectId());
			html.replace("%id%", id);
		...
		else if (actualCommand.equalsIgnoreCase("doors_confirm_upgrade"))
		{
			...
			{
				html.setFile("data/html/chamberlain/doors-already-updated.htm", player);
			...
			else
			{
				...
				html.setFile("data/html/chamberlain/doors-success.htm", player);
			}
			html.replace("%objectId%", getObjectId());
			player.sendPacket(html);
		}
		else if (actualCommand.equalsIgnoreCase("traps_update"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			if (val.isEmpty())
				html.setFile("data/html/chamberlain/" + getNpcId() + "-tu.htm", player);
			else
			{
				html.setFile("data/html/chamberlain/traps-update" + ((getCastle().getName().equalsIgnoreCase("aden")) ? "1" : "") + ".htm", player);
		...
		else if (actualCommand.equalsIgnoreCase("traps_choose_upgrade"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/chamberlain/traps-confirm.htm", player);
			html.replace("%objectId%", getObjectId());
		...
		else if (actualCommand.equalsIgnoreCase("traps_confirm_upgrade"))
		{
			...
			{
				html.setFile("data/html/chamberlain/traps-already-updated.htm", player);
			...
			else
			{
				...
				html.setFile("data/html/chamberlain/traps-success.htm", player);
			}
			html.replace("%objectId%", getObjectId());
			player.sendPacket(html);
		}
	...
	public void showChatWindow(Player player)
	{
		...
		{
			case NONE:
				html.setFile("data/html/chamberlain/no.htm", player);
				break;
			...
			default:
				html.setFile("data/html/chamberlain/chamberlain.htm", player);
				break;
		}
		html.replace("%objectId%", getObjectId());
		player.sendPacket(html);
