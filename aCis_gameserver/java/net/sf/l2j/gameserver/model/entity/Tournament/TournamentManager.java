...
public class TournamentManager
{
	...
	public void unspawnNpc()
	{
		...
		_npcSpawn.setRespawnDelay(999999); // Desativa respawn automático
	...
	public void spawnNpcEvent()
	{
		...
		try
		{
			...
			_npcSpawn.setRespawnDelay(1); // Ativa respawn com delay de 1 segundo
			//_npcSpawn.startRespawn();     // Inicia o respawn automático
	...
	public void showHtml(Player player, String page, TournamentFightType type)
	{
		...
		htm.setFile("data/html/mods/tournament/" + page + ".htm", player);
	...
	{
		NpcHtmlMessage htm = new NpcHtmlMessage(0);
		htm.setFile("data/html/mods/tournament/ranking/info/playerInfo" + type.name() + ".htm", player);
	...
	{
		NpcHtmlMessage htm = new NpcHtmlMessage(0);
		htm.setFile("data/html/mods/tournament/ranking/" + rankType + "/" + fightType.name() + ".htm", player);
