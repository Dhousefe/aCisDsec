...
public final class ItemInstance extends WorldObject implements Runnable, Comparable<ItemInstance>
{
	...
	public void setPriceToSell(int price) {
	    this.customSellPrice = price;
	}

	public int getDefaultSellPrice() {
    // Normalmente o preço de venda padrão é metade do preço de referência
    return getReferencePrice() / 2;
	}

	public int getPriceToSell() {
	    return customSellPrice >= 0 ? customSellPrice : getDefaultSellPrice();
	}
}