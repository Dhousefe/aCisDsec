...
public class FishingChampionshipManager
{
		...
		for (Fisher fisher : _winPlayers)
		{
			if (fisher.getRewardType() != 2 && fisher.getName().equalsIgnoreCase(player.getName()))
			{
				...
				if (rewardCnt > 0)
				{
					...
					html.setFile("data/html/fisherman/championship/fish_event_reward001.htm", player);
	...
	public void showMidResult(Player player)
	{
		...
		if (_needRefresh)
		{
			html.setFile("data/html/fisherman/championship/fish_event003.htm", player);
			player.sendPacket(html);
		...
		html.setFile("data/html/fisherman/championship/fish_event002.htm", player);
	...
	public void showChampScreen(Player player, int objectId)
	{
		...
		html.setFile("data/html/fisherman/championship/fish_event001.htm", player);
