...
public class AdminInfo implements IAdminCommandHandler
{
	...
	public void useAdminCommand(String command, Player player)
	{
		if (command.startsWith("admin_info"))
		{
			...
			{
				html.setFile("data/html/admin/doorinfo.htm", player);
			...
			else if (targetWorldObject instanceof Summon targetSummon)
			{
				...
				html.setFile("data/html/admin/petinfo.htm", player);
			...
			{
				html.setFile("data/html/admin/staticinfo.htm", player);
	...
	{
		html.setFile("data/html/admin/npcinfo/default.htm", null);
	...
	private static void sendDropInfos(Npc npc, NpcHtmlMessage html, int page, int subPage, boolean isDrop)
	{
		...
		for (DropCategory category : list)
		{
			...
			final Pagination<DropData> droplist = new Pagination<>(category.getDrops().stream().sorted(Comparator.comparing(DropData::chance).reversed()), subPage, 6);
			for (DropData drop : droplist)
			{
				...
				final String amount = (drop.getMinDrop() == drop.getMaxDrop()) ? drop.getMinDrop() + "" : drop.getMinDrop() + " - " + drop.getMaxDrop();
	...
	public static void sendGeneralInfos(Npc npc, NpcHtmlMessage html, int index)
	{
		switch (index)
		{
			case 0:
			default:
				html.setFile("data/html/admin/npcinfo/general-0.htm", null);
			...
			case 1:
				html.setFile("data/html/admin/npcinfo/general-1.htm", null);
			...
			case 2:
				html.setFile("data/html/admin/npcinfo/general-2.htm", null);
	...
	{
		html.setFile("data/html/admin/npcinfo/script.htm", null);
	...
	{
		html.setFile("data/html/admin/npcinfo/spawn.htm", player);
	...
	{
		html.setFile("data/html/admin/npcinfo/stat.htm", null);
