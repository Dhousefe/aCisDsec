...
public class AdminAlternativeSpawn implements IAdminCommandHandler
{
	...
	private static void showNpcMakersInfo(Player player, int page)
	{
		...
		adminReply.setFile("data/html/admin/spawnlist/maker_check.htm", player);
	...
	{
		final NpcHtmlMessage adminReply = new NpcHtmlMessage(0);
		adminReply.setFile("data/html/admin/spawnlist/maker_info.htm", player);
	...
	{
		final NpcHtmlMessage adminReply = new NpcHtmlMessage(0);
		adminReply.setFile("data/html/admin/spawnlist/maker_scripts.htm", player);
