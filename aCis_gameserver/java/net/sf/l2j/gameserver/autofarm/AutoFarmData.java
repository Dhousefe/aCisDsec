...
public class AutoFarmData
{
	...
	/*
	 * Restauramos somente o essencial. O resto e criado conforme a demanda
	 */
	public void restorePlayer(Player player)
	{
		...
		{
			LOGGER.error("Nao foi possivel restaurar as AutoFarmArea do player {}.", e, player.getName());
		}
	}
	...
	public void deleteArea(int playerId, int areaId)
	{
		...
		{
			LOGGER.error("Nao foi possivel deletar a AutoFarmArea id #{}.", e, areaId);
		}	
	}
	...
	public void insertNodes(AutoFarmArea area)
	{
		...
		{
			LOGGER.error("Nao foi possivel salvar os nodes da AutoFarmArea id #{}.", e, area.getId());
		}
	}
	...
	public void insertArea(int playerId, AutoFarmArea area)
	{
		...
		{
			LOGGER.error("Nao foi possivel salvar a AutoFarmArea id #{}.", e, area.getId());
		}
	}
