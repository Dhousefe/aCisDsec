...
public class AutoFarmProfile
{
	...
	/*
	 * Usamos o nome do Npc ao inves do seu ID porque e comum que muitos tenham o mesmo nome, mas nao o mesmo ID
	 */
	...
	/**
	 * @return Titulo utilizado pelo player antes de ativar o auto farm
	 */
	...
	/*
	 * Ei! Voce aa, que tal reescrever isso?
	 */
