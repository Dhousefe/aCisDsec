...
public class CastleWarehouseKeeper extends WarehouseKeeper
{
	...
	public void showChatWindow(Player player, int val)
	{
		...
		{
			case NONE:
				html.setFile("data/html/castlewarehouse/castlewarehouse-no.htm", player);
				break;
			
			case UNDER_SIEGE:
				html.setFile("data/html/castlewarehouse/castlewarehouse-busy.htm", player);
				break;
			
			default:
				if (val == 0)
					html.setFile("data/html/castlewarehouse/castlewarehouse.htm", player);
				else
					html.setFile("data/html/castlewarehouse/castlewarehouse-" + val + ".htm", player);
				break;
		}
